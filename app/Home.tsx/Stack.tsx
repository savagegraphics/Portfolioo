...
const Stack = (props: Props) => {
  return (
    <section className="px-4 py-24 mx-auto max-w-7xl">
      <h1 className="mb-12 text-sm font-bold tracking-wide text-center text-gray-800">
        Unveiling My Frontend Arsenal: Next.js, React, Vercel, GitHub, and
        Beyond!
      </h1>
      <div className="grid grid-cols-2 gap-10 text-center lg:grid-cols-8">
        <div className="flex items-center justify-center">
          ...
          <img
            ...
            alt=" Nextjs Logo"
            className="block object-contain h-12 pl-4"
          />
        </div>
        <div className="flex items-center justify-center">
          <img
        ...
        <div className="flex items-center justify-center">
          <img
            src="./logos/git.svg"
            alt="GIT Logo"
            className="block object-contain h-10"
          />
        </div>
        <div className="flex items-center justify-center">
          <img
            src="./logos/github-2.svg"
            alt="Github Logo"
            className="block object-contain h-8 lg:h-12"
          />
        </div>
        <div className="flex items-center justify-center">
          <img
            ...
            className="block object-contain h-12 w-40"
          />
        </div>
        <div className="flex items-center justify-center">
          <img
            ...
            alt="Vercel Logo"
            className="block object-contain lg:h-24 h-20"
          />
        </div>
        <div className="flex items-center justify-center">
          <img
        ...
        <div className="flex items-center justify-center">
          <img
            ...
            alt="WebPack Logo"
            className="block object-contain h-14 lg:h-14"
          />
        </div>
        <div className="flex items-center justify-center">
          <svg
            className="data-[auto=true]:sm:hidden block text-foreground w-6 h-6 md:hidden"
            fill="currentColor"
            height="25"
            viewBox="0 0 43 43"
            width="25"
